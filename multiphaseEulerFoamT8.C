...
Description
    ...
    which update void fraction and mass fraction of species based a pre-determined
    chemical reaction. The code must be adapted and modified on deband basis.
...
int main(int argc, char *argv[])
{
    ...
    #include "thermochimicaCoupling/thermochimicaFields/gaseousFields.H"
    #include "thermochimicaCoupling/thermochimicaFields/liquidFields.H"
    #include "thermochimicaCoupling/thermochimicaFields/massFieldsGas.H"
    #include "thermochimicaCoupling/thermochimicaFields/massFieldsLiquid.H"
    #include "thermochimicaCoupling/thermochimicaFields/vapourPressureFields.H"
    #include "thermochimicaCoupling/thermochimicaVariables.H"
    #include "thermochimicaCoupling/chemicalPropertiesTC.H"
        ...
        while (pimple.loop())
        {
            if (!pimple.flow())
            {
                ...
                if (pimple.thermophysics())
                {
                   ...
                   #include "Yof_to_Ytc.H" 
                   #include "YEqns3.H" 
                   #include "Ytc_to_Yof.H" 
